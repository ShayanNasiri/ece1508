...
CMD=(python -m recipe_mpr_qa.cli train-slm --config configs/slm_smollm2_135m_finetune_original_highcap_loglikelihood.toml)
...
python "${REPO_ROOT}/slurm/prune_run_checkpoints.py" \
  ...
  --run-id "smollm2-135m-finetune-original-highcap-loglikelihood"
